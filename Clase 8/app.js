...
// 🐞 2. Setear atributos con .setAttribute()
// Le pasamos 2 parametros, siendo el primero  el atributo a setear, y el segundo el valor del mismo
...
/*
  🐞 6. Ejercicio: Beeper
    ...
    2. Creá un archivo .js y vinculalo a tu html usando un tag script,
...
var seEjecutaEnEvento = function () {
    body.insertAdjacentHTML('beforeend', '<p id="beep">BEEP</p>')
...
/*
    ...
    5. Volvé a la función callback del evento y agregale una línea que haga
     un .classList.toggle("color") sobre el body, cambiándole el color con cada click.*/

 /*   6. Ahora definí la función del callback afuera del evento, guardándola 
 en una variable que se llame seEjecutaEnEvento.
    Remplazá la función callback por la variable seEjecutaEnEvento 
    (que contiene la misma función) y asegurate de que el programa funcione igual
*/